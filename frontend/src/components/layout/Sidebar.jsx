  ...
  return (
    <aside className="w-64 bg-white dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 min-h-screen flex flex-col transition-colors">
      <div className="p-4 flex items-center gap-3 border-b border-gray-200 dark:border-gray-700">
        ...
        <div>
          <div className="font-semibold bg-gradient-to-r from-pulsegreen to-pulseblue bg-clip-text text-transparent">
            PulseAI
          </div>
          ...
          return (
            <Link 
              ...
              className={`flex items-center gap-3 p-3 rounded-lg transition-all duration-200 ${
                isActive 
                  ? 'bg-gradient-to-r from-pulsegreen to-pulseblue text-white shadow-lg' 
